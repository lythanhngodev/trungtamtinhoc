...
$sql = "
    SELECT DISTINCT HOTEN,NGAYSINH,SOHIEU,SOGHISO,NGAYVAOSO,GIOITINH,NOISINH,DIEMLT,DIEMTH,TENDS,sha2(sha2(IDDKTHV,256),224) AS 'IDDKTHV',THILT,THITH,DIEMLTPK,DIEMTHPK FROM vwChungChi cc WHERE sha2(SHA2(IDDKTHV,256),224)='$key';
";
