...
for ($i=0; $i < count($bhv); $i++) {
	...
	if (strlen($sotien)==0) {
		$qr_hocvien.= "UPDATE hocvien_lop SET HOCPHI=NULL,MASOBIENLAI='$sobienlai',NGAYGHIBIENLAI='$ngayghibienlai' WHERE IDHVL='$idhvl';";
	}else{
		$qr_hocvien.= "UPDATE hocvien_lop SET HOCPHI='$sotien',MASOBIENLAI='$sobienlai',NGAYGHIBIENLAI='$ngayghibienlai' WHERE IDHVL='$idhvl';";
	}
}
