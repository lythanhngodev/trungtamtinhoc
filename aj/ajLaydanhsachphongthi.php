...
if ($stt==0) {
    for($i=0;$i<$tong;$i++){ ?>
        <tr><td class='text-center'><?php echo $so; ?></td><td><input type='text' class='form-control' name="ao[]" required="required" /></td><td><input type='text' class='form-control' name="thuc[]" required="required" /></td><td><input type='date' class='form-control' name="ngaythi[]" required="required" /></td></tr>
<?php ++$so;}
    die();
}
$so=1;
...
<tr>
    <td class='text-center'><?php echo $so;++$so; ?></td>
    <td><input type='text' class='form-control' value='<?php echo $row['TENGOINHO']; ?>' name="ao[]" required="required" /></td>
